...
const ProductView = () => {
  ...
  return (
    <div className="container mx-auto ">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 p-6 w-full mx-auto my-20">
        ...
        <div className="lg:col-span-2 flex lg:flex-col gap-4 justify-center ">
          {thumbnails.map((img, index) => (
            <img
              ...
              className={`w-30 h-30 p-5  rounded-xl cursor-pointer border-2 ${mainImg === img ? "border-black" : "border-gray-200"
                }`}
            />
          ))}
        </div>
